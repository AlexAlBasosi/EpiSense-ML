...
features = list(data.columns[2:20])
x = data[features]
y = data["diagnosis"]
...
# To test new data
testdata = pd.read_csv("FINALTEST2.csv")
#testdata = testdata.drop("id",1)


testfeatures = list(testdata.columns[2:20]) 
...
df.to_csv('FINALOUTPUT3.csv')



##f = open('FINALOUTPUT2.csv', "r")
##readCSV = csv.reader('FINALOUTPUT2.csv',delimiter= ",")
##
